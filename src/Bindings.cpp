...
PYBIND11_MODULE(pymultineat, m) {
    ...
    py::class_<NEAT::Population>(m, "Population")
        ...
        .def("IncrementNextGenomeID", &NEAT::Population::IncrementNextGenomeID)
        .def("GetNextSpeciesID", &NEAT::Population::GetNextSpeciesID)
        .def("IncrementNextSpeciesID", &NEAT::Population::IncrementNextSpeciesID)
        ...
        .def("ComputeSparseness", &NEAT::Population::ComputeSparseness)
    ...
    py::class_<NEAT::Species>(m, "Species")
        ...
        .def("SetBestSpecies", &NEAT::Species::SetBestSpecies)
        .def("SetWorstSpecies", &NEAT::Species::SetWorstSpecies)
        .def("IncreaseAgeGens", &NEAT::Species::IncreaseAgeGens)
        .def("ResetAgeGens", &NEAT::Species::ResetAgeGens)
        .def("IncreaseGensNoImprovement", &NEAT::Species::IncreaseGensNoImprovement)
        .def("IncreaseAgeEvals", &NEAT::Species::IncreaseAgeEvals)
        .def("ResetAgeEvals", &NEAT::Species::ResetAgeEvals)
        .def("IncreaseEvalsNoImprovement", &NEAT::Species::IncreaseEvalsNoImprovement)
        .def("SetOffspringRqd", &NEAT::Species::SetOffspringRqd)
        .def("GetOffspringRqd", &NEAT::Species::GetOffspringRqd)
        .def("NumIndividuals", &NEAT::Species::NumIndividuals)
        .def("ClearIndividuals", &NEAT::Species::ClearIndividuals)
        ...
        .def("AddIndividual", &NEAT::Species::AddIndividual)
        ...
        .def("CountOffspring", &NEAT::Species::CountOffspring)
        .def("AdjustFitness", &NEAT::Species::AdjustFitness)
        .def("SortIndividuals", &NEAT::Species::SortIndividuals)
        .def("RemoveIndividual", &NEAT::Species::RemoveIndividual)
        .def("CalculateAverageFitness", &NEAT::Species::CalculateAverageFitness)
        .def("ReproduceOne", &NEAT::Species::ReproduceOne)
